...
nix.settings = {
  ...
  networking.hostName = "TengriOS"; # Define your hostname.
...
'';
 ...
 services.picom.enable = true;
  ...
  users.users.TengriOS = {
     passwd = 1234
     isNormalUser = true;
     extraGroups = [ "wheel" "tengrios" "TengriOS" "kvm" "input" "disk" "libvirtd" "users" "usrs" ];  Enable ‘sudo’ for the user.
  };
